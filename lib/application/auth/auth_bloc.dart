...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  AuthBloc({required this.authService}) : super(Loading()) {
    ...
    //check authentication status initial and navigate to home page or login page
    on<CheckAuthStatus>((event, emit) async {
      emit(Loading());
      final bool authStatus = await authService.checkAuthStatus();
      authStatus ? emit(Authenticated()) : emit(UnAuthenticated());
    });
  }
}
